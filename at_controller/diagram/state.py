...
from typing import Optional, Literal, List, Union, Dict, TypedDict, TYPE_CHECKING, Any
import math
import numpy as np
import operator
...
class AndCondition(Condition):
    type: Literal['and']
    arguments: List[Union[EquatationCondition, InclusionCondition, 'AndCondition', 'OrCondition', 'NotCondition', 'NonArgOperationCondition', 'BinaryOperationCondition']]
...
class NotCondition(Condition):
    type: Literal['not']
    condition: Union[EquatationCondition, InclusionCondition, AndCondition, OrCondition, 'NotCondition', 'NonArgOperationCondition', 'BinaryOperationCondition']
...
class EventTransition(Transition):
    ...
    trigger_condition: Optional[Union[EquatationCondition, InclusionCondition, AndCondition, OrCondition, NotCondition]] = field(default=None)
